...
if (/(android|blackberry|iphone|ipod)/i.test(navigator.userAgent) && window.innerWidth < 500) {
  ...
  warningDom.setAttribute('style', 'position: fixed; top: 0; left: 0; bottom: 0; right: 0; padding: 1rem; font-family: \'Helvetica Neue\', Helvetica, sans-serif; font-weight: 100; background: #181F21; color: #86E0C4; box-sizing: border-box; z-index: 99999;');
